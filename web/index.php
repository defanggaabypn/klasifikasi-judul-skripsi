                    ...
                    <div class="card-body">
                        ...
                        <div class="alert alert-secondary mt-3 mb-0">
                            <small>
                                ...
                                <strong>Tech Stack:</strong> Python Flask + IndoBERT + Scikit-learn | PHP + Bootstrap
                            </small>
                        </div>
                    </div>
                </div>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            uploadForm.addEventListener('submit', function(e) {
                ...
                .catch(error => {
                    ...
                    showCustomAlert('Terjadi kesalahan saat memproses file. Silakan coba lagi.', 'danger');
                });
            });
            ...
            downloadTemplateBtn.addEventListener('click', function() {
                ...
                .catch(error => {
                    console.error('Error:', error);
                    showCustomAlert('Gagal mengunduh template. Silakan coba lagi.', 'danger');
                });
            });
        });
    </script>
