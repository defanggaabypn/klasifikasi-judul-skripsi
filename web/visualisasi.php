            ...
            <div class="card-body">
                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane fade show active" id="overview" role="tabpanel" aria-labelledby="overview-tab">
                        <h4 class="mb-4"><i class="bi bi-bar-chart-line me-2"></i>Distribusi Kategori Judul Skripsi</h4>
                    ...
                    <div class="tab-pane fade" id="keywords" role="tabpanel" aria-labelledby="keywords-tab">
                        <h4 class="mb-4"><i class="bi bi-tags me-2"></i>Kata Kunci Populer per Kategori</h4>
                    ...
                    <div class="tab-pane fade" id="performance" role="tabpanel" aria-labelledby="performance-tab">
                        <h4 class="mb-4"><i class="bi bi-graph-up me-2"></i>Performa Model Klasifikasi</h4>
                    ...
                    <div class="tab-pane fade" id="similar" role="tabpanel" aria-labelledby="similar-tab">
                        <h4 class="mb-4"><i class="bi bi-search me-2"></i>Cari Judul Skripsi Serupa</h4>
                        ...
                        <div class="title-search">
                            <form id="similarTitleForm">
                                <div class="mb-3">
                                    <label for="searchTitle" class="form-label">Masukkan Judul Skripsi:</label>
                    ...
                    <div class="tab-pane fade" id="comparison" role="tabpanel" aria-labelledby="comparison-tab">
                        <h4 class="mb-4"><i class="bi bi-arrow-left-right me-2"></i>Perbandingan KNN dan Decision Tree</h4>
